      ...
      <div className="transfer-info">
        {transfer.from_driver_id && (
          <div className="transfer-from">
            <img src={`${baseUrl}/${transfer?.from_driver?.profile_photo}`} alt="From Driver" className="driver-image" />
            <p><strong>From Driver:</strong> {transfer?.from_driver?.name} (ID: {transfer?.from_driver_id})</p>
          </div>
        )}
        <div className="transfer-to">
          <img src={`${baseUrl}/${transfer?.to_driver?.profile_photo}`} alt="To Driver" className="driver-image" />
